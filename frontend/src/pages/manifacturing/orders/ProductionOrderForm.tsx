...
//       bomId: selectedBOMId,
//       bomVersion:
//         bomsList.find((b) => b.id === selectedBOMId)?.version || '1.0',
...
//                           <div
//                             key={insp.id}
//                             className={`flex items-center justify-between rounded-lg border px-4 py-3 ${insp.status === 'PASSED'
...
//                               <div
//                                 className={`w-8 h-8 flex items-center justify-center rounded-full ${insp.status === 'PASSED'
...
//                             <div className="flex items-center gap-3">
//                               <span
//                                 className={`text-xs px-2 py-0.5 rounded-full font-medium border ${insp.status === 'PASSED'
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      {selectedRouting && (
                        <span className="text-[11px] text-[#94a3b8] whitespace-nowrap">
                          Est: {formatShortDate(plannedStart)} +{' '}
                          {Math.ceil(selectedRouting.totalTimeMinutes / 60 / 8)} days
                        </span>
                      )}
                    </div>
                    {selectedRouting && (
